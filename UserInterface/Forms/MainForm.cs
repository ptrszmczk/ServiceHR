using ServiceHR.UserInterface.Forms.Employees;
using ServiceHR.UserInterface.Forms.Contracts;
using System;
    ...
    public partial class MainForm : Form
    {
        ...
        private void tcTabs_DrawItem(object sender, DrawItemEventArgs e)
        {
            try
            {
                ...
                tabRect.Inflate(-2, -2);
                var closeImage = new Bitmap($"{ResourcesHelper.ResourceFilePath}\\{ResourcesHelper.CloseButtonName}");
